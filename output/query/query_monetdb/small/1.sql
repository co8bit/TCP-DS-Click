...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('KY', 'GA', 'SD')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('VA', 'TX', 'AL')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OK', 'IL', 'CA')
...
select case when (select count(*) 
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 21783
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 11192
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 40107
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 34605
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('1999-03-07' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('1999-03-07' as date) - interval '30 days')
                    and (cast ('1999-03-07' as date) + interval '30 days')
...
select  channel, col_name, d_year, d_qoy, i_category, COUNT(*) as sales_cnt, SUM(ext_sales_price) as sales_amt FROM (
        ...
        UNION ALL
        SELECT 'web' as channel, 'ws_warehouse_sk' as col_name, d_year, d_qoy, i_category, ws_ext_sales_price as ext_sales_price
...
select  i_item_id
 ...
 and d_date between cast('1998-05-13' as date) and (cast('1998-05-13' as date) +  interval '60 days')
 and i_manufact_id in (884,777,747,766)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-05-08' as date) and (cast('2000-05-08' as date) +  interval '60 days')
 and i_manufact_id in (735,55,287,95)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select   
 ...
 from (
   ...
   and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
   and t_time between 25340 and 25340+28800 
     ...
     (select avg(ss_list_price) as B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 118 and 118+10
          or ss_coupon_amt between 4922 and 4922+1000
          or ss_wholesale_cost between 53 and 53+20)) as B2,
     (select avg(ss_list_price) as B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 50 and 50+10
          or ss_coupon_amt between 2143 and 2143+1000
          or ss_wholesale_cost between 16 and 16+20)) as B3,
     ...
     (select avg(ss_list_price) as B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 64 and 64+10
          ...
          or ss_wholesale_cost between 7 and 7+20)) as B5,
     (select avg(ss_list_price) as B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 24 and 24+10
          or ss_coupon_amt between 12392 and 12392+1000
          or ss_wholesale_cost between 5 and 5+20)) as B6
limit 100;
...
select  c_customer_id as customer_id
 ...
 where ca_city          =  'Bethel'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  25695
   and ib_upper_bound   <=  25695 + 50000
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2000-05-27' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-05-27' as date) - interval '30 days')

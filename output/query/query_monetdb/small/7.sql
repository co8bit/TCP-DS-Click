...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('ID', 'TN', 'IL')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NE', 'ME', 'MS')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 41978
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 10233
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 34953
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 9281
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 28442
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('1998-06-01' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('1998-06-01' as date) - interval '30 days')
...
select  channel, col_name, d_year, d_qoy, i_category, COUNT(*) as sales_cnt, SUM(ext_sales_price) as sales_amt FROM (
        ...
        UNION ALL
        SELECT 'web' as channel, 'ws_web_site_sk' as col_name, d_year, d_qoy, i_category, ws_ext_sales_price as ext_sales_price
         FROM web_sales, item, date_dim
         WHERE ws_web_site_sk IS NULL
           AND ws_sold_date_sk=d_date_sk
           AND ws_item_sk=i_item_sk
        UNION ALL
        SELECT 'catalog' as channel, 'cs_ship_mode_sk' as col_name, d_year, d_qoy, i_category, cs_ext_sales_price as ext_sales_price
...
select  i_item_id
 ...
 and d_date between cast('2000-02-18' as date) and (cast('2000-02-18' as date) +  interval '60 days')
 and i_manufact_id in (837,751,814,703)
...
select  i_item_id
 ...
 and i_manufact_id in (97,260,246,754)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select   
 ...
 from (
   ...
   and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
   and t_time between 2292 and 2292+28800 
   and sm_carrier in ('ZHOU','LATVIAN')
     group by 
        w_warehouse_name
   ,w_warehouse_sq_ft
   ,w_city
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Tazewell County','McMinn County','Lewis County','Marinette County','Judith Basin County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
from (select avg(ss_list_price) as B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 186 and 186+10 
             or ss_coupon_amt between 10533 and 10533+1000
     ...
     (select avg(ss_list_price) as B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 2 and 2+10
          or ss_coupon_amt between 3067 and 3067+1000
          or ss_wholesale_cost between 72 and 72+20)) as B2,
     (select avg(ss_list_price) as B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 149 and 149+10
          or ss_coupon_amt between 4803 and 4803+1000
     ...
     (select avg(ss_list_price) as B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 60 and 60+10
          or ss_coupon_amt between 9124 and 9124+1000
          or ss_wholesale_cost between 13 and 13+20)) as B4,
     (select avg(ss_list_price) as B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 115 and 115+10
          or ss_coupon_amt between 2890 and 2890+1000
          or ss_wholesale_cost between 12 and 12+20)) as B5,
     (select avg(ss_list_price) as B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 177 and 177+10
          or ss_coupon_amt between 14057 and 14057+1000
          or ss_wholesale_cost between 77 and 77+20)) as B6
limit 100;
...
select  c_customer_id as customer_id
 ...
 where ca_city          =  'Lebanon'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  30478
   and ib_upper_bound   <=  30478 + 50000
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2000-05-09' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-05-09' as date) - interval '30 days')
                and (cast ('2000-05-09' as date) + interval '30 days') 
 group by
    w_state,i_item_id

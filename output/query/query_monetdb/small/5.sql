...
and d_date between '2000-02-06' and 
        (cast('2000-02-06' as date) + interval '90 days')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('WV', 'TX', 'NY')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('IN', 'AL', 'GA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('FL', 'NE', 'IA')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 32851
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 38867
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 6606
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 481
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 9001
            then (select avg(ss_ext_tax)
                  from store_sales
...
select  channel, col_name, d_year, d_qoy, i_category, COUNT(*) as sales_cnt, SUM(ext_sales_price) as sales_amt FROM (
        ...
        UNION ALL
        SELECT 'web' as channel, 'ws_ship_cdemo_sk' as col_name, d_year, d_qoy, i_category, ws_ext_sales_price as ext_sales_price
         FROM web_sales, item, date_dim
         WHERE ws_ship_cdemo_sk IS NULL
           AND ws_sold_date_sk=d_date_sk
           AND ws_item_sk=i_item_sk
        UNION ALL
        SELECT 'catalog' as channel, 'cs_bill_addr_sk' as col_name, d_year, d_qoy, i_category, cs_ext_sales_price as ext_sales_price
...
select  i_item_id
 ...
 and d_date between cast('2001-01-07' as date) and (cast('2001-01-07' as date) +  interval '60 days')
 and i_manufact_id in (729,830,836,818)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-01-23' as date) and (cast('2002-01-23' as date) +  interval '60 days')
 and i_manufact_id in (554,449,833,739)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select   
 ...
 from (
   ...
   and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
   and t_time between 18421 and 18421+28800 
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Franklin County','Pondera County','McDuffie County','Genesee County','Wicomico County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
     ...
     (select avg(ss_list_price) as B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 107 and 107+10
          ...
          or ss_wholesale_cost between 29 and 29+20)) as B2,
     (select avg(ss_list_price) as B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 28 and 28+10
          or ss_coupon_amt between 1548 and 1548+1000
          or ss_wholesale_cost between 63 and 63+20)) as B3,
     (select avg(ss_list_price) as B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 183 and 183+10
          or ss_coupon_amt between 3216 and 3216+1000
          or ss_wholesale_cost between 62 and 62+20)) as B4,
     (select avg(ss_list_price) as B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 54 and 54+10
          or ss_coupon_amt between 6899 and 6899+1000
     ...
     (select avg(ss_list_price) as B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 70 and 70+10
          or ss_coupon_amt between 846 and 846+1000
          or ss_wholesale_cost between 49 and 49+20)) as B6
limit 100;
...
select  c_customer_id as customer_id
 ...
 where ca_city          =  'Clifton'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  21146
   and ib_upper_bound   <=  21146 + 50000

...
and d_date between '1999-03-22' and 
        (cast('1999-03-22' as date) + interval '90 days')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('FL', 'AK', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AL', 'ID', 'OR')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KS', 'CO', 'VA')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 42983
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 18169
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 14174
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 19636
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 30992
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2000-02-15' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2000-02-15' as date) - interval '30 days')
                    and (cast ('2000-02-15' as date) + interval '30 days')
...
select  channel, col_name, d_year, d_qoy, i_category, COUNT(*) as sales_cnt, SUM(ext_sales_price) as sales_amt FROM (
        SELECT 'store' as channel, 'ss_promo_sk' as col_name, d_year, d_qoy, i_category, ss_ext_sales_price as ext_sales_price
         FROM store_sales, item, date_dim
         WHERE ss_promo_sk IS NULL
           AND ss_sold_date_sk=d_date_sk
           AND ss_item_sk=i_item_sk
        UNION ALL
        SELECT 'web' as channel, 'ws_web_page_sk' as col_name, d_year, d_qoy, i_category, ws_ext_sales_price as ext_sales_price
...
select  i_item_id
 ...
 and d_date between cast('1999-06-07' as date) and (cast('1999-06-07' as date) +  interval '60 days')
 and i_manufact_id in (945,930,986,882)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-06-08' as date) and (cast('2002-06-08' as date) +  interval '60 days')
 and i_manufact_id in (119,451,428,416)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select   
 ...
 from (
   ...
   and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
   and t_time between 43760 and 43760+28800 
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Carroll County','Cleveland County','Wayne County','Harding County','Henry County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
from (select avg(ss_list_price) as B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 91 and 91+10 
             or ss_coupon_amt between 11573 and 11573+1000
     ...
     (select avg(ss_list_price) as B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 41 and 41+10
          ...
          or ss_wholesale_cost between 17 and 17+20)) as B2,
     (select avg(ss_list_price) as B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 109 and 109+10
          ...
          or ss_wholesale_cost between 41 and 41+20)) as B3,
     (select avg(ss_list_price) as B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 75 and 75+10
          ...
          or ss_wholesale_cost between 12 and 12+20)) as B4,
     (select avg(ss_list_price) as B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 56 and 56+10
          or ss_coupon_amt between 10605 and 10605+1000
          or ss_wholesale_cost between 47 and 47+20)) as B5,
     (select avg(ss_list_price) as B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 1 and 1+10
          or ss_coupon_amt between 15635 and 15635+1000
          or ss_wholesale_cost between 34 and 34+20)) as B6
limit 100;
...
select  c_customer_id as customer_id
 ...
 where ca_city          =  'Ashland'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  46841
   and ib_upper_bound   <=  46841 + 50000
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2000-02-03' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-02-03' as date) - interval '30 days')
                and (cast ('2000-02-03' as date) + interval '30 days') 
 group by
    w_state,i_item_id

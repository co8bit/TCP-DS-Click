...
explain analyze select  cast(amc as decimal(15,4))/cast(pmc as decimal(15,4)) as am_pm_ratio
...
explain analyze select  channel, col_name, d_year, d_qoy, i_category, COUNT(*) as sales_cnt, SUM(ext_sales_price) as sales_amt FROM (
...
explain analyze select  i_brand_id as brand_id, i_brand as brand,
...
explain analyze select i_brand_id as brand_id, i_brand as brand,t_hour,t_minute,
...
explain analyze select  ca_zip, ca_county, sum(ws_sales_price)
...
explain analyze select  i_brand_id as brand_id, i_brand as brand, i_manufact_id, i_manufact,
   sum(ss_ext_sales_price) as ext_price
...
explain analyze select  a.ca_state as state, count(*) as cnt

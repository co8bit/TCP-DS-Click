...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('VA', 'CT', 'NE')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NC', 'ID', 'MO')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OH', 'MT', 'KS')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 12
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 38810
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 41464
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 40704
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 7495
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
select  i_item_id
 ...
 and i_manufact_id in (999,683,755,945)
...
select  i_item_id
 ...
 and i_manufact_id in (373,774,485,446)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select   
 ...
 from (
   ...
   and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
   and t_time between 11502 and 11502+28800 
   and sm_carrier in ('TBS','ZHOU')
     group by 
        w_warehouse_name
   ,w_warehouse_sq_ft
   ,w_city
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Emporia city','Falls Church city','Carter County','Martinsville city','Butte County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
from (select avg(ss_list_price) as B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 119 and 119+10 
             or ss_coupon_amt between 7131 and 7131+1000
     ...
     (select avg(ss_list_price) as B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 15 and 15+10
          or ss_coupon_amt between 14656 and 14656+1000
     ...
     (select avg(ss_list_price) as B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 29 and 29+10
          or ss_coupon_amt between 6512 and 6512+1000
          or ss_wholesale_cost between 29 and 29+20)) as B3,
     (select avg(ss_list_price) as B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 77 and 77+10
          ...
          or ss_wholesale_cost between 2 and 2+20)) as B4,
     (select avg(ss_list_price) as B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 129 and 129+10
          ...
          or ss_wholesale_cost between 28 and 28+20)) as B5,
     (select avg(ss_list_price) as B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 116 and 116+10
          ...
          or ss_wholesale_cost between 62 and 62+20)) as B6
limit 100;
...
select  c_customer_id as customer_id
 ...
 where ca_city          =  'Spring Valley'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  9566
   and ib_upper_bound   <=  9566 + 50000
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-05-30' as date) - interval '30 days')
                and (cast ('2000-05-30' as date) + interval '30 days') 
 group by
    w_state,i_item_id

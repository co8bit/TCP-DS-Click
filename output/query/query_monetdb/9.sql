...
and d_date between '2001-03-04' and 
        (cast('2001-03-04' as date) + interval '90 days')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_country = 'United States'
  and ca_state in ('IA', 'VA', 'WI')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'IN', 'UT')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 6218
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 22701
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 44939
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 9738
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 31883
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2002-03-28' as date) - interval '30 days')
...
select  channel, col_name, d_year, d_qoy, i_category, COUNT(*) as sales_cnt, SUM(ext_sales_price) as sales_amt FROM (
        ...
        UNION ALL
        SELECT 'catalog' as channel, 'cs_ship_customer_sk' as col_name, d_year, d_qoy, i_category, cs_ext_sales_price as ext_sales_price
...
select  i_item_id
 ...
 and d_date between cast('2000-04-18' as date) and (cast('2000-04-18' as date) +  interval '60 days')
 and i_manufact_id in (692,955,806,718)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-01-24' as date) and (cast('2002-01-24' as date) +  interval '60 days')
 and i_manufact_id in (183,64,72,431)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select   
 ...
 from (
   ...
   and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
   and t_time between 27631 and 27631+28800 
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Knott County','Nacogdoches County','Muskegon County','Broome County','Cleburne County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
     ...
     (select avg(ss_list_price) as B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 70 and 70+10
          or ss_coupon_amt between 6162 and 6162+1000
          or ss_wholesale_cost between 60 and 60+20)) as B2,
     (select avg(ss_list_price) as B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 69 and 69+10
          or ss_coupon_amt between 5826 and 5826+1000
          or ss_wholesale_cost between 44 and 44+20)) as B3,
     (select avg(ss_list_price) as B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 82 and 82+10
          or ss_coupon_amt between 6966 and 6966+1000
          or ss_wholesale_cost between 40 and 40+20)) as B4,
     (select avg(ss_list_price) as B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 44 and 44+10
          ...
          or ss_wholesale_cost between 3 and 3+20)) as B5,
     (select avg(ss_list_price) as B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 173 and 173+10
          or ss_coupon_amt between 14412 and 14412+1000
          or ss_wholesale_cost between 8 and 8+20)) as B6
limit 100;
...
select  c_customer_id as customer_id
 ...
 where ca_city          =  'Lakeside'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  63204
   and ib_upper_bound   <=  63204 + 50000
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2000-03-30' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-03-30' as date) - interval '30 days')
                and (cast ('2000-03-30' as date) + interval '30 days') 
 group by
    w_state,i_item_id

...
explain select  channel, col_name, d_year, d_qoy, i_category, COUNT(*) as sales_cnt, SUM(ext_sales_price) as sales_amt FROM (
...
explain select  i_brand_id as brand_id, i_brand as brand,
...
explain select i_brand_id as brand_id, i_brand as brand,t_hour,t_minute,
...
explain select  i_brand_id as brand_id, i_brand as brand, i_manufact_id, i_manufact,
   sum(ss_ext_sales_price) as ext_price
...
explain select  a.ca_state as state, count(*) as cnt
